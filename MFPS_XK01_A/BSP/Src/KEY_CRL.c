...
void KEY4_press()
{
    ...
    }else
    {
        ...
        {
            case ALARM_1:
                if( gui_info.alarm_temp1_value < 125 )
                {
                    gui_info.alarm_temp1_value += 1;
                }
                alarm_temp_dis();
            ...
            case ALARM_2:
                if( gui_info.alarm_temp2_value < 125 )
                {
                    gui_info.alarm_temp2_value += 1;
                }
                alarm_temp_dis();
            ...
            case ALARM_3:
                if( gui_info.alarm_temp3_value < 125 )
                {
                    gui_info.alarm_temp3_value += 1;
                }
                alarm_temp_dis();
...
void KEY3_press()
{
    ...
    }else
    {
        switch(gui_beat.beat_select)
        {
            case ALARM_1:
                refresh_icon();
                gui_beat.beat_select = ALARM_2;
    
                break;
    
            case ALARM_2:
                refresh_icon();
                gui_beat.beat_select = ALARM_3;
    
                break;
    
            case ALARM_3:
                refresh_icon();
                gui_beat.beat_select = ALARM_1;

                break;

            case BAKE_POWER:
                refresh_icon();
                gui_beat.beat_select = BAKE_FAN;
    
                break;
    
            case BAKE_FAN:
                refresh_icon();
                gui_beat.beat_select = BAKE_POWER;
...
void KEY2_press()
{
    ...
    }else
    {
        ...
        {
            case ALARM_1:
                if( gui_info.alarm_temp1_value > 25 )
                {
                    gui_info.alarm_temp1_value -= 1;
                }
                alarm_temp_dis();
            ...
            case ALARM_2:
                if( gui_info.alarm_temp2_value > 25 )
                {
                    gui_info.alarm_temp2_value -= 1;
                }
                alarm_temp_dis();
            ...
            case ALARM_3:
                if( gui_info.alarm_temp3_value > 25 )
                {
                    gui_info.alarm_temp3_value -= 1;
                }
                alarm_temp_dis();
